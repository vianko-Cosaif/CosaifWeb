// Utility para transiciones comunes
...
type ToastKind = "move" | "error" | "info";
...
export const S = {
  ...
  /* =========================================
     ...
     ========================================= */
  Header: {
    // Añadido backdrop-saturate para efecto 'premium' y shadow-sm
    ...
    dot: "hidden xs:inline-block w-2.5 h-2.5 rounded-full bg-emerald-500 shadow-[0_0_8px_rgba(16,185,129,0.4)] ml-1", // Dot con glow

    // Botones con lógica de estado mejorada
  ...
  /* =========================================
     ...
     ========================================= */
  Card: {
    // Card principal con mejor profundidad y borde
    ...
    // Tipografía tabular para números estables
  ...
  Toast: {
    ...
    item: (kind: ToastKind) =>
      `pointer-events-auto shadow-xl shadow-slate-900/5 rounded-xl px-4 py-3 flex items-center gap-3 max-w-[320px] border backdrop-blur-xl text-xs font-bold animate-in slide-in-from-bottom-5 fade-in duration-300 ${
        kind === "move"
