          ...
          {showNextButton && (
            <GuidedTarget id="create-movement-next-step" className="inline-flex min-w-0 flex-1 min-[420px]:flex-none">
              <button
                ...
                className="cosaif-motion-button min-h-10 w-full rounded-xl bg-gradient-to-r from-emerald-500 to-emerald-600 px-4 py-2 text-xs font-black text-white shadow-lg shadow-emerald-500/25 hover:from-emerald-600 hover:to-emerald-700 hover:shadow-emerald-500/40 sm:min-h-11 sm:px-5 sm:py-2.5 sm:text-sm"
              >
                {guidedNextLabel}
              </button>
            </GuidedTarget>
