  ...
  return (
    <label className={cn("block min-w-0", containerClassName)}>
      ...
      <span className="relative block">
        ...
        <select
          className={cn(
            "h-11 w-full appearance-none rounded-lg border border-[var(--app-border)] bg-[var(--app-surface)] px-3 pr-9 text-sm font-medium text-[var(--app-text)] shadow-sm transition-colors",
