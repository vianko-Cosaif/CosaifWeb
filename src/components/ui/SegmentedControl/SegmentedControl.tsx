...
const sizeClasses = {
  ...
  md: {
    button: "min-h-11 px-4 py-2 text-sm",
      ...
      {options.map((option) => {
        ...
        return (
          <button
            ...
            className={cn(
              "inline-flex min-w-0 items-center justify-center gap-2 rounded-md font-semibold transition-colors focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[var(--app-accent)]",
              sizes.button,
              active
