    ...
    >
      ...
      <div className="flex min-w-0 flex-col gap-3 lg:flex-row lg:items-center lg:justify-between">
        ...
        <GuidedTarget id="movements-scope-tabs" className="relative inline-flex w-full min-w-0 sm:w-auto lg:flex-none">
          <div className="relative inline-flex w-full min-w-0 rounded-lg border border-[var(--app-border)] bg-[var(--app-surface-muted)] p-0.5 sm:w-auto sm:min-w-[250px] sm:p-1">
            {/* Animated indicator */}
            <div
              className="absolute bottom-0.5 top-0.5 rounded-md bg-[var(--app-surface)] shadow-sm transition-[left] duration-200 motion-reduce:transition-none sm:bottom-1 sm:top-1"
              style={{
        ...
        <div className="flex min-w-0 flex-wrap items-center justify-end gap-2 sm:gap-2 lg:flex-1">
          ...
          <GuidedTarget id="movements-refresh" className="inline-flex shrink-0">
            <Button
              ...
              aria-label={tituloBotonRefrescar}
              onClick={onRefrescar}
            ...
            <GuidedTarget id="movimientos-new-button" className="inline-flex min-w-0 shrink">
              <GuidedTarget id="client-new-movement" className="inline-flex min-w-0">
                <Button
                  ...
                  variant="primary"
                  size="md"
                  className="min-h-11 min-w-0 shrink px-3 sm:px-4"
      ...
      <GuidedTarget id="movements-search" className="relative block">
        <div className="relative">
          ...
          {/* Loading shimmer bar */}
          {estaCargando && (
            <div className="absolute bottom-0 left-2 right-2 h-[2px] overflow-hidden rounded-full motion-reduce:hidden">
...
function TabBoton({
  ...
  return (
    <button
      ...
      aria-pressed={activo}
      className={[
        "relative z-10 flex min-h-11 min-w-0 flex-1 items-center justify-center rounded-md px-4 py-2 text-center text-sm font-semibold transition-colors",
