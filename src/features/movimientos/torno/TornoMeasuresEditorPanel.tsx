...
import { DynamicTable, type DynamicTableColumn } from "@/components/dynamic-table";
...
export default function TornoMeasuresEditorPanel(props: Props) {
  ...
  }, [fieldDefs, pastedTargets, readonly, tornoMedicion.rows, openCopyModal, openMeasureModal]);
