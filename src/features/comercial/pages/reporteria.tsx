...
import type { AnalyticsSummary, BillingCut, CommercialOperation, Contract } from "../types";
import CommercialPeriodBar from "../components/CommercialPeriodBar";
import { useCommercialData } from "../components/CommercialDataProvider";
import { Modal, ModuleHeader, Notice } from "../components/CommercialUi";
...
export default function ReportingPage() {
  ...
  useEffect(() => {
    ...
    Promise.all(sortedMonths.map((month) => {
      ...
      return loadCompleteAnalytics(`/bff/comercial/analitica?${query}`, { signal: controller.signal });
    }))
  ...
  const { items: cuts, loading: cutsLoading, error: cutsError } = useCrmCatalog<BillingCut>(`/bff/comercial/cobranza/cortes?${cutQuery}`);
