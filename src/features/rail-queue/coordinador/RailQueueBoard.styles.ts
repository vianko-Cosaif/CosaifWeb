...
export const S = {
  ...
  lastUpdate:
    "whitespace-nowrap text-xs text-[var(--app-text-muted)]",
  offlineChip:
  ...
  /* ===== LEFT COLUMN ===== */
  leftCol:
    "min-w-0 rounded-lg border border-[var(--app-border)] bg-[var(--app-surface)] p-3 text-[var(--app-text)] shadow-[var(--app-shadow-sm)] sm:p-5 lg:col-span-2",
  leftHeader:
  ...
  companyName: "mt-1 break-words text-sm font-medium text-[var(--app-text-muted)]",
  ...
  locoValue:
    "text-3xl font-black text-[var(--app-accent)] sm:text-5xl md:text-6xl lg:text-7xl",
  ...
  detailText: "text-sm font-medium break-words",
  createdWrap: "mt-3 max-w-xs",
  instructions:
    "mt-3 break-words text-xs sm:text-sm text-zinc-700 dark:text-zinc-200",

  /* ===== RIGHT COLUMN ===== */
  aside:
    "min-w-0 h-fit lg:max-h-[calc(90vh-100px)] lg:overflow-y-auto rounded-lg border border-[var(--app-border)] bg-[var(--app-surface)] p-4 text-[var(--app-text)] shadow-[var(--app-shadow-sm)]",
  asideHeader:
    "sticky top-0 z-10 mb-4 flex items-center justify-between bg-[var(--app-surface)] pb-2",
  asideTitle: "flex items-center gap-2 font-bold text-lg",
  asideCount:
  ...
  kvValue: "truncate text-sm font-medium break-words",
  ...
  nextExtra:
    "mt-3 break-words space-y-2 text-[11px] sm:text-xs text-zinc-600 dark:text-zinc-300",
