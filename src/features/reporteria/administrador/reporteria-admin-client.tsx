...
const loading = () => <p role="status" className="rounded-2xl border border-[var(--app-border)] bg-[var(--app-surface)] p-6 text-[var(--app-text-muted)]">Preparando reporte…</p>;
const CumplimientoReport = dynamic(() => import("./reports/ceo-cumplimiento/components/CumplimientoReport"), { loading });
const TraficoClienteReport = dynamic(() => import("./reports/ceo-trafico-cliente/components/TraficoClienteReport"), { loading });
const TurnosReport = dynamic(() => import("./reports/ceo-turnos/components/TurnosReport"), { loading });
const MaquinistasReport = dynamic(() => import("./reports/ceo-maquinistas/components/MaquinistasReport"), { loading });
const ComparativoReport = dynamic(() => import("./reports/ceo-comparativo/components/ComparativoReport"), { loading });
...
export default function ReporteriaAdminClient() {
  ...
  return (
    <div className={`${theme.root} space-y-5`}>
        ...
        {reportOptions.map((opt) => {
          ...
          return (
            <button
              ...
              style={{ "--tone": opt.tone } as React.CSSProperties}
            >
