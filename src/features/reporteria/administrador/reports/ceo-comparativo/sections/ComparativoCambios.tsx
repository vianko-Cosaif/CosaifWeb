...
import type { ComparativoCambiosProps } from "../../types";
        ...
        <div className="col-span-12 xl:col-span-6">
          <ConfigurableTable
            ...
            columns={[
              ...
              { key: "actual", label: "Actual", format: (v: unknown) => fmtMaybeInt(v) },
              { key: "anterior", label: "Anterior", format: (v: unknown) => fmtMaybeInt(v) },
              { key: "delta", label: "Delta", format: (v: unknown) => fmtMaybeInt(v) },
              { key: "deltaPct", label: "Delta %", format: (v: unknown) => fmtMaybePct(v) },
            ]}
          />
        </div>
        <div className="col-span-12 xl:col-span-6">
