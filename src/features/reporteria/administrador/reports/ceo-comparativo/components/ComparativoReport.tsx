  ...
  return (
    ...
    >
      {report.activeTab === "overview" && (
        <>
          <ComparativoResumen resumen={report.rawReport?.resumen} />
          <ComparativoBuckets
            actual={report.rawReport?.actual?.ejecucionBuckets ?? []}
            anterior={report.rawReport?.anterior?.ejecucionBuckets ?? []}
          />
        </>
      )}
      ...
      {report.activeTab === "operaciones" && (
        <ComparativoCambios
          cambiosEmpresas={report.rawReport?.cambiosEmpresas ?? []}
          cambiosClientes={report.rawReport?.cambiosClientes ?? []}
        />
      )}
