...
import type { TurnosResumenProps } from "../../types";
...
export default function TurnosResumen({ turnos }: TurnosResumenProps) {
      ...
      <section className="grid grid-cols-12 gap-4">
        {turnos.map((t) => (
          <div key={t.turnoId ?? t.turnoLabel} className="col-span-12 md:col-span-6 xl:col-span-4">
            <ChartCard title={t.turnoLabel ?? "TurnosResumenTurno"} subtitle={t.turnoRango ?? ""} accent="amber">
