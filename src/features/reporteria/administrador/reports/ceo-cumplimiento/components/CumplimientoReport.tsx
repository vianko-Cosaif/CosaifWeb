        ...
        <>
          ...
          <section className="grid grid-cols-12 gap-4">
            <div className="col-span-12 md:col-span-4 xl:col-span-3">
              <KpiCard title="Cancelados" value={fmtMaybeInt(report.kpis?.cancelados)} accent="rose" />
            </div>
            <div className="col-span-12 md:col-span-4 xl:col-span-3">
              <KpiCard
                title="Cancelados con incidente"
                value={fmtMaybeInt(report.kpis?.canceladosConIncidente)}
                accent="amber"
              />
            </div>
          </section>
          <CumplimientoEstados estados={report.rawReport?.estadosGeneral} />
        </>
      )}
      ...
      {report.activeTab === "operaciones" && (
        <>
          ...
          <CumplimientoSegmentacion
            porEmpresa={report.rawReport?.porEmpresa ?? []}
            porLocalidad={report.rawReport?.porLocalidad ?? []}
            porTurno={report.rawReport?.porTurno ?? []}
          />
        </>
      )}
